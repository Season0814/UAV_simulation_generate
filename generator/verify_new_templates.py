...
def main():
    ...
    sensor_xml = generator.generate_component(sensor_desc, "standard_sensors.sdf.template")
    print(sensor_xml)
    
    print("\n\n=== Test 2: Joint Template (Defaults) ===")
    # Description is empty to trigger defaults
    joint_desc = "A standard rotor joint."
    joint_xml = generator.generate_component(joint_desc, "joint.sdf.template")
    print(joint_xml)
    
    print("\n\n=== Test 3: Motor Plugin Template (Defaults) ===")
    # Description is empty to trigger defaults
    motor_desc = "A standard motor plugin."
    motor_xml = generator.generate_component(motor_desc, "motor_plugin.sdf.template")
    print(motor_xml)
    ...
    motor_custom_xml = generator.generate_component(motor_custom_desc, "motor_plugin.sdf.template")
